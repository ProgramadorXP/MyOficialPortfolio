...
const image = '/src/assets/images/me.jpg';
const Banner = () => {
    ...
    return (
        <section className="mt-10 lg:flex lg:justify-center lg:items-end">
            ...
            <div>
                ...
                <div className="flex justify-center">
                    <a href="/src/assets/cv/Mi CV.pdf" className="bg-zinc-900 dark:bg-white dark:text-orange-600 text-zinc-50 cursor-pointer px-4 py-2 rounded-lg tracking-wide transition-all duration-500 hover:bg-amber-600 hover:text-zinc-50 dark:hover:bg-amber-600 dark:hover:text-white">Download CV</a>
                    <span className="flex justify-center items-center text-zinc-900 dark:text-white text-2xl mx-3"><a href="https://www.linkedin.com/in/jonhatanvillalobos/" className="transition-all duration-200 hover:text-amber-600 hover:scale-125"><FontAwesomeIcon icon={faLinkedin}/></a></span>
